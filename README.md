...
<img src="docs/assets/demo.gif" alt="A terminal running ff: a glance at the branches, changes on main parked by a single switch, a commit, a fix folded into it, then pull and push." width="900">
...
- **First-class agent support.** A shipped skill and built-in nudging. A snapshot lands before every agent tool call, letting a sloppy agent reverse its bad decisions.
