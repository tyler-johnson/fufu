...
`ff hook --skill <name>` prints a declared extension's skill the way a bare `ff hook --skill` prints fufu's own. [`ff unhook`](unhook.md) takes fufu's wiring and the extensions' back together.
