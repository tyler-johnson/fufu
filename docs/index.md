...
fufu (`ff`) is an opinionated version control interface for humans and agents: automatic snapshots, branching, and undo of recorded local work. It is [built on ordinary git](concepts/invariant.md), so your tools, your teammates, and your remotes all still work.
