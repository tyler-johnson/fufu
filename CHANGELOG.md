...
- The error ids `extension/bad-manifest`, `extension/delegate-failed`, `extension/handshake-failed`, `extension/name-mismatch`, `extension/not-declared`, `extension/not-found`, `extension/registry-unreadable`, `extension/registry-unwritable`, `extension/unsupported-contract`, `usage/mcp-extension-undeclared`, `usage/mcp-extension-not-undoable`, and `usage/mcp-policy-write`.
