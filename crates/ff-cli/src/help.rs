...
pages! {
    ...
    EXTENSION_ADD    EXTENSION_ADD_EXAMPLES    "help/extension-add.md"
    EXTENSION_LIST   EXTENSION_LIST_EXAMPLES   "help/extension-list.md"
    EXTENSION_REMOVE EXTENSION_REMOVE_EXAMPLES "help/extension-remove.md"
